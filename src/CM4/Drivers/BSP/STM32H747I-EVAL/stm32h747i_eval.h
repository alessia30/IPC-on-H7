/**
  ...
  * @brief   This file contains definitions for STM32H747I_EVAL:
  *          LEDs
  *          push-buttons
  *          Joystick
  *          POT
...
#ifndef STM32H747I_EVAL_H
#define STM32H747I_EVAL_H
#ifdef __cplusplus
extern "C" {
#endif
...
/** @defgroup STM32H747I_EVAL_LOW_LEVEL_Exported_Types LOW LEVEL Exported Types
  * @{
  */
typedef enum
{
...
/** @defgroup STM32H747I_EVAL_LOW_LEVEL_Exported_Constants LOW LEVEL Exported Constants
  * @{
  */
/**
...
#define STM32H747I_EVAL_BSP_VERSION        ((STM32H747I_EVAL_BSP_VERSION_MAIN << 24)\
                                            ...
                                            |(STM32H747I_EVAL_BSP_VERSION_SUB2 << 8 )\
                                            |(STM32H747I_EVAL_BSP_VERSION_RC))

#define STM32H747I_EVAL_BSP_BOARD_NAME  "STM32H747I-EVAL";
#define STM32H747I_EVAL_BSP_BOARD_ID    "MB1246E";

/** @defgroup STM32H747I_EVAL_LOW_LEVEL_LED LOW LEVEL LED
  * @{
  */
#define GPIO_LEDn                         1U

#define LED1_GPIO_PORT                   GPIOK
#define LED1_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOK_CLK_ENABLE()
#define LED1_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOK_CLK_DISABLE()
#define LED1_PIN                         GPIO_PIN_3

#define LED2_GPIO_PORT                   GPIOK
#define LED2_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOK_CLK_ENABLE()
#define LED2_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOK_CLK_DISABLE()
#define LED2_PIN                         GPIO_PIN_4
#define LED3_GPIO_PORT                   GPIOK
#define LED3_GPIO_CLK_ENABLE()           __HAL_RCC_GPIOK_CLK_ENABLE()
#define LED3_GPIO_CLK_DISABLE()          __HAL_RCC_GPIOK_CLK_DISABLE()
...
/** @defgroup STM32H747I_EVAL_LOW_LEVEL_JOYSTICK LOW LEVEL JOYSTICK
  * @{
  */
#if (USE_BSP_IO_CLASS > 0)
/* Joystick pins are connected to IO Expander (accessible through I2C2 interface) */
...
#define JOY1_NONE_PIN                  (IO_PIN_0 | IO_PIN_1 |  IO_PIN_2 | IO_PIN_3 | IO_PIN_4)
#define JOY1_ALL_PIN                   JOY1_NONE_PIN
...
/** @defgroup STM32H747I_EVAL_LOW_LEVEL_BUTTON LOW LEVEL BUTTON
  * @{
  */
/**
...
#if (USE_BSP_POT_FEATURE > 0)
/** @defgroup STM32H747I_EVAL_LOW_LEVEL_POT LOW LEVEL POT
  * @{
  */
/**
...
/** @defgroup STM32H747I_EVAL_LOW_LEVEL_Exported_Macros LOW LEVEL Exported Macros
  * @{
  */
